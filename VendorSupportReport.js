...
import { customerSupportUrl, customersUrl, mealPlanUrl, vendorSupportUrl } from '../../assets/Api/api'
...
export default function CustomerReport() {
    ...
    const getData = (values) => {
        ...
        axios.post(`${vendorSupportUrl}/GetSupportsForReportOnFilter`, data)
            .then(response => {
                console.log(response);
                setReports(response)
                setVendorSupport(response.data.data.support)
            })
            .catch(error => {
    ...
    return (
        <AccountLayout title="Vendor support report">
            <BodyContainer>
