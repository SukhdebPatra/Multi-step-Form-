...
export default function VendorSupport() {
    ...
    const getTickets = (data) => {
        axios.post(`${supportUrl}/GetSupportsOnFilter`, data)
            .then(response => {
    ...
    const getSupportDetails = (id) => {
        axios.get(`${supportUrl}/GetSupport/${id}`)
            .then(response => {
                console.log(response);
    ...
    const addReply = () => {
        ...
        msg.append('supportId', selectedTicket[0].id);
        msg.append('vendorsId', user.id);
        ...
        // }
        // console.log(data);
        axios.post(`${supportUrl}/AddSupportReply`, msg)
            .then(response => {
                console.log(response);
                getSupportDetails(response.data.data.supportId)
                setReplyMsg({
                    msg: '',
                    attachment: ''
                })
            ...
            .catch(error => {
                console.log(error.response);
                getSupportDetails(error.response.data.data.supportId)
            })
    }
    const imageInput = (e) => {
    ...
    const handleSubmit = (event) => {
        ...
        data.append('vendorsId', user.id);
        data.append('storeId', store.id);
        ...
        if (form.checkValidity() === false) {
            ...
            axios.post(`${supportUrl}/AddSupport`, data)
                .then(response => {
                    console.log(response);
    ...
    const updateStatus = () => {
        ...
        console.log(data);
        axios.put(`${supportUrl}/UpdateChatStatus`, data)
            .then(response => {
                console.log(response);
        ...
        <AccountLayout title="Customer Support" loader={false}>
            ...
            <BodyContainer>
                <div className="card-header">
                    <BodyHeader toogle={toogleAdd} search={search} setSearch={setSearch} addBtn={true} />
                                                ...
                                                <div className="col-xl-4 xl-30 col-md-5">
                                                    <div className="nav flex-column nav-pills"
                                                        ...
                                                        <div id="div-support-tickets">
                                                            {supportTickets && supportTickets.support.map(ticket => {
                                                                return (
                                                                                                ...
                                                                                                <div id="div-chat-history">
                                                                                                    <div className="chat-history chat-msg-box custom-scrollbar" >
                                                                                                        <ul>
                                                                                                            ...
                                                                                                            {
                                                                                                                selectedTicket?.[0].supportReply.map(msg => {
                                                                                                                    let CreatedTime = formatDate(msg.createdAt);
                                                                                                                    if (msg.replyFrom != 3) {
                                                                                                                        if (msg.attachment == null) {
                                                                                                                            return (
