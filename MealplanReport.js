...
import { customersUrl, mealPlanUrl } from '../../assets/Api/api'
...
export default function CustomerReport() {
    ...
    const columns = [
        ...
        },
        {
            ...
            selector: row => row.activeCustomers,
            sortable: true,
            compact: true
        },
        {
            name: 'Total Collection',
            selector: row => (row.symbol + row.totalCollections),
            sortable: true,
            compact: true
        },
        {
    ...
    const getData = (values) => {
        ...
        axios.post(`${mealPlanUrl}/GetProgramMenuPlansForReport`, data)
            .then(response => {
                console.log(response);
                setReports(response)
                setMealplanReport(response.data.data.programMenuPlansForReport)
            })
            .catch(error => {
    ...
    return (
        <AccountLayout title="Mealplan report">
            <BodyContainer>
